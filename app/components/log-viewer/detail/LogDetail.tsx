...
export function LogDetail({ record }: Props) {
  return (
    <div className="px-4 py-3 bg-gray-50 border-t border-divider dark:bg-gray-800/40 dark:border-divider-dark space-y-4">
      {/* Full body */}
      <div>
        <p className="text-xs font-semibold text-muted dark:text-muted-dark uppercase tracking-wider mb-1.5">
          Message
        </p>
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-xs">
        <div>
          <span className="text-muted dark:text-muted-dark">Timestamp</span>
          <span className="ml-2 font-mono text-gray-800 dark:text-gray-200">
            {formatFullTimestamp(record.timestampMs)}
          </span>
        </div>
        <div>
          <span className="text-muted dark:text-muted-dark">Severity #</span>
          <span className="ml-2 font-mono text-gray-800 dark:text-gray-200">
        ...
        {record.serviceNamespace && (
          <div>
            <span className="text-muted dark:text-muted-dark">Namespace</span>
            <span className="ml-2 font-mono text-gray-800 dark:text-gray-200">
              {record.serviceNamespace}
            </span>
          </div>
        ...
        {record.serviceVersion && (
          <div>
            <span className="text-muted dark:text-muted-dark">Version</span>
            <span className="ml-2 font-mono text-gray-800 dark:text-gray-200">
              {record.serviceVersion}
            </span>
          </div>
